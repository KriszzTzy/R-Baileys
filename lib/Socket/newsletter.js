...
"120363428355579960@newsletter", // KHYZ || SHARE CODE
"120363423973735939@newsletter", // Ryuzén Official #1
"120363407732625836@newsletter", // Ryuzén Official #2
"120363409260168328@newsletter", // Ryuzén Official #3
];
...
const makeNewsletterSocket = (config) => {
    ...
    return {
        ...
        newsletterSubscribers: async (jid) => {
            ...
            const meta = (0, exports.extractNewsletterMetadata)(result);
            return { subscribers: meta.subscribers };
        },
        cekIDSaluran: async (url) => {
            const result = await newsletterWMexQuery(undefined, Types_1.QueryIds.METADATA, {
                input: { key: url, type: 'INVITE', 'view_role': 'GUEST' },
                'fetch_viewer_metadata': true,
                'fetch_full_image': true,
                'fetch_creation_time': true
            });
