...
function _printPairingSuccess(pairingCode) {
    const line = `${_QRV_RED}${'─'.repeat(20)}${_QRV_RESET}`;
    console.log('');
    console.log(line);
    console.log(`  ${_QRV_BRED}❱❱  R-BAILEYS — SOCKETS${_QRV_RESET}`);
    ...
    console.log('');
    console.log(`  ${_QRV_YELLOW}✦ Thanks for using R-Baileys${_QRV_RESET}`);
    console.log(`  ${_QRV_YELLOW}✦ ${_QRV_BRED}By Kristian${_QRV_RESET}`);
    console.log(line);
    console.log('');
}
...
// ═════════════════════════════
    const requestPairingCode = async (phoneNumber, pairKey = "RB4IL3YS") => {
